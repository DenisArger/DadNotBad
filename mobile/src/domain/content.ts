  ...
  'math-1-counting': [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини число и его следующее число.',
          hint: 'У каждого числа справа то, которое идет сразу после него.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини число и то, что идет сразу после.',
          hint: 'Сначала найди на единицу больше каждого числа.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини число с предыдущим числом.',
          hint: 'У каждого числа выбери то, что идет перед ним.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини описание с правильным числом.',
          hint: 'Вспомни, какое число находится в каждом условии.',
          answer: 'pair-1:18|pair-2:20',
          pairs: [
            { id: 'pair-1', left: 'между 17 и 19', right: '18' },
            { id: 'pair-2', left: 'после 19', right: '20' },
          ],
        },
      ],
    },
  ...
  'math-1-addition': [
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hint: 'Решай по одному примеру, потом ищи его ответ.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини сумму с правильным ответом.',
          hint: 'Посчитай оба примера и подбери ответы.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини пример с его значением.',
          hint: 'У каждого примера справа должен быть верный ответ.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини равенства с ответами.',
          hint: 'Реши их и найди совпадения.',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          type: 'matching',
          prompt: 'Соедини суммы чисел с ответом.',
          hint: 'Сначала посчитай оба примера сам.',
          answer: 'pair-1:8|pair-2:10',
          pairs: [
